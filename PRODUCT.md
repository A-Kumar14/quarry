# Quarry — Product Vision

## One Line
Research that shows its epistemic work — for anyone who needs to understand
...
2. 4-Step Pipeline — replace single LLM call with structured claim extraction
...
- KnowledgeGraph.js — force graph from answer concepts
- PerspectivesTab.js — Reddit threads per query
- ResearchPage.js — multi-turn research assistant
- Citation service — APA/MLA/Chicago/BibTeX formatters
- Finance service — yfinance quotes and charts
